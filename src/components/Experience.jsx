          ...
          <div className="relative pl-8 md:pl-12">
            ...
            <div className="p-6 md:p-8 rounded-xl bg-gray-900/50 border border-gray-800 hover:border-blue-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 mb-4 text-sm md:text-base leading-relaxed">
                Currently working as a <span className="text-blue-400 font-semibold">Full Stack Web Developer Intern</span> at <span className="text-blue-400 font-semibold">Kalvig</span>, where I design and deploy scalable web applications. My role involves both frontend and backend development using modern frameworks and tools.
              </p>
