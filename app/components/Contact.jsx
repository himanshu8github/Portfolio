          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              <a
                ...
                className={`group p-3 rounded-xl bg-gray-900/50 border border-gray-800 ${getColorClass(method.color)} transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 hover:scale-[1.05] animate-slideUp`}
