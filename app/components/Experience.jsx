      ...
      <div className="space-y-8">
        ...
        <div className="animate-slideUp" style={{animationDelay: "0.1s"}}>
          <div className="relative pl-8 md:pl-12">
            {/* Timeline dot */}
            <div className="absolute left-0 top-1 w-6 h-6 md:w-8 md:h-8 bg-gradient-to-r from-blue-400 to-purple-600 rounded-full flex items-center justify-center hover:scale-125 transition-transform">
            ...
            {/* Card */}
            <div className="p-6 md:p-8 rounded-xl bg-gray-900/50 border border-gray-800 hover:border-blue-500/50 transition-all duration-300 hover:scale-[1.02] cursor-pointer">
